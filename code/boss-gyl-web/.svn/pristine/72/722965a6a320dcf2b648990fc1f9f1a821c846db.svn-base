		...
		<div id="slideEidt">
			<div class="slide-cnt">
				<component-slide @fetch-data="fetchData"  :id="model.invInventory.inventoryId" :show.sync="show" :tab-data.sync="tabData" :active-index.sync="activeIndex">
					...
					<erp:privilege key="GYL_INVENTORY_DETAIL_VIEW ">
									...
									<div class="ui-panel">
										...
										<!-- 合同信息 -->
											<div class="ui-panel-body scroll-body">
												...
												<div class="ui-form-group ui-col">
													<label class="ui-label-control ui-col ui-col-10">合同单价</label>
													<div class="ui-col ui-col-40 ui-label-txt">
														<span>{{model.invInventory.contractUnitPrice == null? 0:model.invInventory.contractUnitPrice}}元</span>
													</div>
													<label class="ui-label-control ui-col ui-col-10">合同金额</label>
													<div class="ui-col ui-col-40 ui-label-txt">
														<span>{{model.invInventory.contractMoney ==null? 0 :model.invInventory.contractMoney}}元</span>
													</div>
												</div>
												<div class="ui-form-group ui-col">
													<label class="ui-label-control ui-col ui-col-10">实际单价</label>
													<div class="ui-col ui-col-40 ui-label-txt">
														<span>{{model.invInventory.realUnitPrice == null? 0:model.invInventory.realUnitPrice }}元</span>
													</div>
													<label class="ui-label-control ui-col ui-col-10">商城价</label>
													<div class="ui-col ui-col-40 ui-label-txt">
														<span>{{model.invInventory.storePrice ==null? 0 : model.invInventory.storePrice}}元</span>
													</div>
												</div>
												<div class="ui-form-group ui-col">
													<label class="ui-label-control ui-col ui-col-10">实际金额</label>
													<div class="ui-col ui-col-90 ui-label-txt">
														<span>{{model.invInventory.realMoney == null? 0 : model.invInventory.realMoney}}元</span>
													</div>
												</div>
											</div>
									</div>
