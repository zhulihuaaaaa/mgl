					...
					<div class="panel-control clearfix">
						...
						<div class="ui-col slide-overflow">
							<div class="main-cnt-scroll">
								<component-table
										id="insInspectionBillFinancialIndex"
									...
									<el-table-column
										...
										min-width="120">
										 <template slot-scope="scope"><!-- 
												...
												<!-- <component-images :data="scope.row.warrantyList" title="质保书"></component-images> -->
											</template>
									</el-table-column>
									<el-table-column
										v-if="false"
										...
										min-width="120">
										 <template slot-scope="scope">
												...
												<component-images :data="scope.row.inventoryVoucherList" title="存货凭证"></component-images>
										</template>
										</el-table-column>
									<el-table-column
										prop="voucherNo"
...
<!-- 私有JS -->
<script src="${ctx}/js/insinspectionbill/insInspectionBillFinancialEditIndex.js"></script>
