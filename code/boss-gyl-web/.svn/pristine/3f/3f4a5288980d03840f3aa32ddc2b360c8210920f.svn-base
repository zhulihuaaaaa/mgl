			...
			<section class="wrapper">
				<div class="ui-row">
					...
					<div class="panel-tit clearfix">
						...
						<erp:privilege key="GYL_INVENTORY_VIEW">
							<span data-privilege="view"></span>
						</erp:privilege>
						<div class="ui-col-50 ui-txt-right">
							<erp:privilege key="GYL_INVENTORY_EXCEL">
								<button type="button"
...
<!-- 私有JS -->
<script src="${ctx}/js/invinventory/invinventoryIndex.js"></script>
