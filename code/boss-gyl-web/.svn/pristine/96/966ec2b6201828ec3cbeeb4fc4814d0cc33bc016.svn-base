$(document).ready(function() {
    ...
    // console.log();
    // // 检测cookie是否有，收起或暂开左侧菜单
    // if (getCookie('_sidebarToggle') === 'true' || getCookie('_sidebarToggle') === null) {
    ...
    $(".sidebar-toggle").click(function() {
        ...
        if (hasSidebar === true) {
            ...
            setCookie('_sidebarToggle', 'false');
        }
        if (hasSidebar === false) {
            famSidebar.addClass("sidebar-close");
            setCookie('_sidebarToggle', 'true');
        }
...
$(".main-cnt-scroll").mCustomScrollbar({
    axis:"yx",
    scrollInertia: 80
});
...
function resizeHeight() {
    ...
    $('.main-cnt-scroll').height(h_num - headH - warpFoot -200);
