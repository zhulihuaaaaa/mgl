									...
									<erp:privilege key="GYL_CONTRACT_APPROVAL">
										<div>
											<component-approval-btn
												...
												:item-id="model.contractId"
												module="contract"
												:show-submit-btn="true"></component-approval-btn>
										</div>
									</erp:privilege>
									<erp:privilege key="GYL_CONTRACT_ADDPAYMENT">
										<a href="javascript:void(0);" class="a-edit ui-ft13 ui-blue" @click="addPayment"  v-if="!(null != flow && flow.canSubmit)">
											<i class="icon-coupon ui-blue"></i>追加货款
										</a>
									</erp:privilege>
									<erp:privilege key="GYL_CONTRACT_ADDDEPOSIT">
										<a href="javascript:void(0);" class="a-edit ui-ft13 ui-blue" @click="addDeposit"  v-if="!(null != flow && flow.canSubmit)">
											<i class="icon-coupon ui-blue"></i>追加保证金
										</a>
									</erp:privilege>
									<erp:privilege key="GYL_CONTRACT_EDIT">
										<a href="javascript:void(0);" class="a-edit ui-ft13 ui-blue" @click="editContract" v-if="null != flow && flow.canSubmit">
											<i class="icon-coupon ui-blue"></i>编辑
										</a>
									</erp:privilege>
									<erp:privilege key="GYL_CONTRACT_DELETE">
										<a href="javascript:void(0);" class="a-edit ui-ft13 ui-blue" @click="delContract" v-if="null != flow && flow.canSubmit">
											<i class="icon-coupon ui-blue"></i>删除
										</a>
									</erp:privilege>
									<erp:privilege key="GYL_CONTRACT_EDIT">
										<a href="javascript:void(0);" class="a-edit ui-ft13 ui-blue" @click="overContract" v-if="!(null != flow && flow.canSubmit)">
											<i class="icon-coupon ui-blue"></i>结束合同
										</a>
									</erp:privilege>
								</div>
							</div>
										...
										<div class="ui-panel-body scroll-body" v-if="activeIndex == 0">
											...
											<div class="ui-col">
												<div class="ui-form-group ui-col-50">
													...
													<div class="ui-col ui-col-60 ui-label-txt">
														<span>{{model.seller.companyName}}</span>
													</div>
												</div>
												<div class="ui-form-group ui-col-50">
