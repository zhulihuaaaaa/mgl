...
require(['ajax', 'component-table', 'util'], function (ajax, componentTable, util) {
	...
	var page = new Vue({
		...
		methods: {
			...
			fetchData (pageConfig) {
				...
				ajax.findPage('/stock', vm.searchParam).then(function (res) {
					// 成功的回调
	...
	$(".btn-export").click(function () {
		ajax.exportExcel('/stock', page.searchParam)
	})
					...
					<div class="ui-col">
						<div class="ui-col">
							<div class="ui-form-group ui-col-60">
								...
								<div class="ui-col-60">
									<input type="text" class="ui-input-control" v-model="productName" placeholder="请输入品类名称">
								</div>
							</div>
						</div>
						<div class="ui-col">
						...
						methods: {
							...
							fetchDataBycheckInv(){
								...
								let id = this.model.invInventory.inventoryId
								 ajax.get("/stock/selectCheckInv",{id:id}).then(function (res) {
