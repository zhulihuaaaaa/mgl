...
<body>
	<section id="container">
		<div id="slideEidt">
			<div class="slide-cnt">
			<component-slide @fetch-data="fetchData" :id="overdueDeferId" :show.sync="show" :tab-data.sync="tabData" :active-index.sync="activeIndex">
						...
						<div class="scroll-tit ui-col">
							...
							<div class="ui-col ui-col-70 scroll-info">
									<p class="pull-left ui-mr32">
										<label>延期天数</label><span>{{model.deferDays}}</span>
									</p>
									<p class="pull-left ui-mr32">
											<label>逾期天数</label><span>{{model.overdueDays}}</span>
										</p>
									<p class="pull-left ui-mr32">
										<label>合同期限</label><span>{{model.contract.contractPeriod}}</span>
									</p> 
							</div>
							<div class="ui-col ui-col-30 ui-txt-right ui-pb6">
								<div>
										<el-button
											v-if="model.auditStatus == 'A'"
											size="small"
											type="primary"
										...
										<el-button
											v-if="model.auditStatus == 'D'"
											size="small"
											type="primary"
											@click="isPassOrNotPass('commissionRate')">修改手续费率
										</el-button>
								</div>
							</div>
						</div>
		...
		<!-- 合同基础信息 -->								
										...
										<div class="ui-col">
												<div class="ui-form-group ui-col-50">
													<label class="ui-label-control ui-col ui-col-30">备注</label>
													<div class="ui-col ui-col-60 ui-label-txt">
														<span>{{tabData[0].info.notes}}</span>
													</div>
												</div>
												<div class="ui-form-group ui-col-50">
													<label class="ui-label-control ui-col ui-col-30">手续费率</label>
													<div class="ui-col ui-col-60 ui-label-txt">
														<span>{{tabData[0].info.commissionRate}}</span>
													</div>
												</div>
										</div>
									</div>
