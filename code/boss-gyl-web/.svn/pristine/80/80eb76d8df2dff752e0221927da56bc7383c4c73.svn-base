...
(function () {
    ...
    var Drawing = useSVG ? svgDrawer : !_isSupportCanvas() ? (function () {
        ...
        function _onMakeImage() {
            if (this._htOption.imgSrc && this._htOption.useCanvas) {
        ...
        Drawing.prototype.draw = function (oQRCode) {
            ...
            if (this._htOption.imgSrc && _isSupportCanvas) {
                ...
                var imgWidth = this._htOption.imgWidth;

                var margin = (qrcode_width - imgWidth) / 2;

                var self = this;
                base_image.onload = function () {
                    _oContext.drawImage(base_image, margin, margin, imgWidth, imgWidth);
                    if (!self._htOption.useCanvas) {
                        self.makeImage();
                    }
                }
                base_image.src = this._htOption.imgSrc;
    ...
    QRCode = function (el, vOption) {
        ...
        this._htOption.imgWidth = this._htOption.width / 4;
        ...
        if (vOption) {
            ...
            if (vOption.width && !vOption.imgWidth) {
                this._htOption.imgWidth = this._htOption.width / 4;
            }
        }
