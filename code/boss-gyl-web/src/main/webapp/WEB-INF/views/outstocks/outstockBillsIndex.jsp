				...
				<div class="ui-row">
					...
					<div class="panel-tit clearfix">
						...
						<div class="ui-col-50 ui-txt-right">
							<erp:privilege key="GYL_OUTSTOCKBILLS_ADD">
								<button type="button" @click="add"
									class="ui-btn ui-btn-primary ui-pw28 btn-add">新建</button>
							</erp:privilege>
							<erp:privilege key="GYL_OUTSTOCKBILLS_EXCEL">
								<button type="button"
							...
							<div class="ui-col search-criter ui-hidden">
								<div class="ui-col-90">
									<div class="ui-form-group pull-left">
										<label class="ui-label-control pull-left">提货委托单号</label>
										<div class="ui-col col-160 ui-mr24 ui-ml4">
											<input type="text" class="ui-input-control"
												placeholder="请输入提货委托单号" v-model="searchParam.dto.outstockCode">
										</div>
									</div>
									<div class="ui-form-group pull-left">
										<label class="ui-label-control pull-left">仓库</label>
										<div class="ui-col col-160 ui-mr24 ui-ml4">
										  	<component-select v-model="searchParam.dto.storageId" type="DictMallDepot" depot="virtual">
                                         	</component-select>
										</div>
									</div>
									<div class="ui-form-group pull-left">
...
<!-- 私有JS -->
<script src="${ctx}/js/outstocks/outstockBillsIndex.js"></script>
