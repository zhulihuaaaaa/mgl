						...
						<div class="ui-row ui-pw15">
							<div class="scroll-tit ui-col">
								...
								<div class="ui-col ui-col-70 scroll-info">
									...
									<!-- 删除权限 -->
								<erp:privilege key="GYL_INSLNSPECTIONBILLSETTLE_DELETE"></erp:privilege>
								<div class="ui-col ui-col-30 ui-txt-right ui-pb6">
									<div v-if="model.insInspectionSub.auditStatus == 'B' ">
										<erp:privilege key="GYL_INSLNSPECTIONBILLSETTLE_AUDIT">
										<p class="pull-left ui-mr32">
											<button type="button"
											class="ui-btn ui-btn-primary ui-pw28 btn-edit-Dialog" @click="passOrNotPass('D')">通过</button>
											<button type="button"
										...
										<div class="ui-panel-body scroll-body" v-if="activeIndex == 0">
											...
											<div class="ui-form-group ui-col">
												...
												<div class="ui-col ui-col-40 ui-label-txt">
													...
													<component-images :data="model.inventoryVoucherList" title="质保书"></component-images>
												</div>
								...
								<div class="swiper-slide">
									<div class="ui-panel">
										<div class="ui-panel-body scroll-body" v-if="activeIndex == 1">
											<h5 class="bg-tit">
												<span>货物信息
												<erp:privilege key="GYL_INSLNSPECTIONBILLSETTLE_EDIT">
