	...
	"_fnGridSetup": function ()
	{
		...
		var nSWrapper =
			$('<div class="DTFC_ScrollWrapper" style="position:relative; clear:both;">'+
				'<div class="DTFC_LeftWrapper datatable-index" style="position:absolute; top:0; left:0;">'+
	...
	"_fnGridLayout": function ()
	{
		...
		var scrollbarAdjust = function ( node, width ) {
			if ( ! oOverflow.bar ) {
				...
				node.style.width = (width+oOverflow.bar-2)+"px";
			}
		};
		...
		if ( this.s.iLeftColumns > 0 )
		{
			...
			oGrid.left.body.style.height = (iBodyHeight + 2)+"px";
			...
			oGrid.left.liner.style.height = (iBodyHeight + 2)+"px";
		}
