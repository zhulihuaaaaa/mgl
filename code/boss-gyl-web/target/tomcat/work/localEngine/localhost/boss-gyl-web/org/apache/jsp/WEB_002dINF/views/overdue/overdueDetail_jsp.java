...
public final class overdueDetail_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	String path=request.getContextPath();/* 获取当前的系统路径 */
      ...
      out.write("</head>");
      out.write("\r\n");
      out.write("<title>逾期详情</title>\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("\t<section id=\"container\">\r\n");
      out.write("\t\t<div id=\"slideEidt\">\r\n");
      out.write("\t\t\t<div class=\"slide-cnt\">\r\n");
      out.write("\t\t\t<component-slide @fetch-data=\"fetchData\" :id=\"contractId\" :show.sync=\"show\" :tab-data.sync=\"tabData\" :active-index.sync=\"activeIndex\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<label>逾期天数</label><span>{{model.overdue}}</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<p class=\"pull-left ui-mr32\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<label>合同期限</label><span>{{model.contractPeriod}}</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</p> \r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\r\n");
  ...
  private boolean _jspx_meth_erp_005fprivilege_005f0(PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/overdue/overdueDetail.jsp(31,13) name = key type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    try {
      ...
      if (_jspx_eval_erp_005fprivilege_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write(" -->\r\n");
          out.write("\t\t\t\t\t\t\t\t<button type=\"button\" v-if=\"contractState == 'B'\" @click=\"applyOverdue\"\r\n");
          out.write("\t\t\t\t\t\t\t\t\tclass=\"ui-btn ui-btn-primary ui-pw28 btn-add\">申请延期</button>\r\n");
          out.write("\t\t\t\t\t\t\t\t<!-- ");
