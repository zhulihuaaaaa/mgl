...
public final class insInspectionBillFinancialEditIndex_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	String path=request.getContextPath();/* 获取当前的系统路径 */
      ...
      out.write("\t\t\t\t\t\t\t<label>金融货物交收审核</label>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<!-- title end -->\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\tid=\"insInspectionBillFinancialIndex\"\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div> -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<!-- <component-images :data=\"scope.row.warrantyList\" title=\"质保书\"></component-images> -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</template>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</el-table-column>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<el-table-column\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tv-if=\"false\"\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div> -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<component-images :data=\"scope.row.inventoryVoucherList\" title=\"存货凭证\"></component-images>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</template>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</el-table-column>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<el-table-column\r\n");
      ...
      out.write("<script src=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (PageContext)_jspx_page_context, null, false));
      out.write("/js/insinspectionbill/insInspectionBillFinancialEditIndex.js\"></script>\r\n");
      out.write("\r\n");
      out.write("<!-- 模块部分公用js -->\r\n");
      out.write("\r\n");
      out.write("</html>");
