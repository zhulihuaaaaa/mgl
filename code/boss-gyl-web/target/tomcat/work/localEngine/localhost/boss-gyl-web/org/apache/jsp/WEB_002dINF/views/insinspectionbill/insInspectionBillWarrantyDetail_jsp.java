...
public final class insInspectionBillWarrantyDetail_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	String path=request.getContextPath();/* 获取当前的系统路径 */
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<label class=\"ui-label-control ui-col ui-col-10\">总重量</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"ui-col ui-col-40 ui-label-txt\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</div> -->\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<component-images :data=\"model.inventoryVoucherList\" title=\"质保书\"></component-images>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t          width=\"120\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t        label=\"升贴水(万元)\"></el-table-column>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t         <el-table-column \r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t          width=\"120\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t        label=\"基价(万元)\"> </el-table-column>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t      <el-table-column\r\n");
      out.write("\t\t\t\t\t\t\t\t\t      \tprop =\"insInspectionDetail.contractMoney\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t         width=\"120\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t        label=\"合同金额(万元)\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t      </el-table-column>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t      <el-table-column\r\n");
      out.write("\t\t\t\t\t\t\t\t\t      \tprop =\"insInspectionDetail.realMoney\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t          width=\"120\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t        label=\"实际金额(万元)\"> </el-table-column>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t      <el-table-column\r\n");
      out.write("\t\t\t\t\t\t\t\t\t      \tv-if=\"false\"\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t      <el-table-column\r\n");
      out.write("\t\t\t\t\t\t\t\t\t       width=\"120\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t      label=\"货物照片\"></el-table-column>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t       <el-table-column\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"ui-col ui-col-60 ui-label-txt\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span>{{contract.invoiceBaseFee}}元</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"ui-col\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"ui-col ui-col-50 ui-label-txt\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span>{{contract.totalMoney != null ? util.formatNumber((contract.totalMoney / 10000), 2) : 0}}万元</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"ui-col\">\r\n");
    ...
    try {
      ...
      if (_jspx_eval_erp_005fprivilege_005f1 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("\t\t\t\t\t\t\t\t\t\t\tclass=\"ui-btn ui-btn-primary ui-pw28 btn-edit-Dialog\" @click=\"passOrNotPass('D')\">通过</button>\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t<button type=\"button\"\r\n");
    ...
    try {
      ...
      if (_jspx_eval_erp_005fprivilege_005f2 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write("\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<!-- <input v-if=\"model.insInspectionSub.auditStatus == 'B' \" type=\"button\" class = \"ui-btn pull-right btn_new_line\" value=\"编辑\" @click=\"bathUpateByProduct\" /> -->\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\r\n");
          out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t");
